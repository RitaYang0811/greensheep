  ...
  <footer class="footer">
    <div class="container-fluid bg-primary py-lg-12 py-8">
      <div class="container-lg text-start">
        <RouterLink to="/admin/home" target="_blank" class="fs-8 text-white d-inline-block mb-4">前往後台 <img src="../components/icons/open-in-new-white.svg" class="align-top" alt="前往後台" /></RouterLink>
        <!-- footer-top -->
        <div class="d-flex flex-lg-row justify-content-lg-between mb-lg-4 flex-column-reverse mb-6">
          ...
          >
            <div class="d-flex mb-lg-0 align-items-lg-center mb-4">
              <li>
                <a href="2-1.productPage.html" class="fs-8 text-white me-lg-6">最新作品</a>
              </li>
              <li>
                <a href="3-1.cusProduct.html" class="fs-8 text-white me-lg-6 mx-lg-0 mx-12"
                  >客製設計</a
                >
              </li>
              <li>
                <a href="4-1.Story.html" class="fs-8 text-white me-lg-6">關於品牌</a>
              </li>
            </div>
            <div class="d-flex align-items-lg-center">
              <li>
                <a href="5-1.blog.html" class="fs-8 text-white me-lg-6 me-12">專欄文章</a>
              </li>
              <li><a href="6-1.faq.html" class="fs-8 text-white">常見問題</a></li>
            </div>
          </ul>
          <div class="footer-top-right d-flex justify-content-between mb-4 mb-lg-0">
            ...
            <div class="me-2 me-lg-6">
              <a href="index.html">
                <img src="../assets/images/logo-white.svg" alt="greensheep logo" class="img-fluid"
              /></a>
            </div>
            <!-- social-medias -->
            <ul class="social-media-list list-unstyled d-flex justify-content-between mb-0">
              ...
              <li class="me-4">
                <a href="https://www.facebook.com/profile.php?id=100071826680344" target="_blank">
                  <!-- fb svg -->
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="40"
                    ...
                    fill="none"
                  >
                    <g clip-path="url(#clip0_2342_4061)">
                      <path
                        opacity="0.7"
                        d="M39.5 20C39.5 30.7696 30.7696 39.5 20 39.5C9.23045 39.5 0.5 30.7696 0.5 20C0.5 9.23045 9.23045 0.5 20 0.5C30.7696 0.5 39.5 9.23045 39.5 20Z"
                        stroke="none"
              ...
              <li>
                <a href="https://www.instagram.com/greensheep_jewelry/" target="_blank">
                  ...
                  <svg
                    ...
                    fill="none"
                  >
                    <g clip-path="url(#clip0_2342_4064)">
                      <path
                        opacity="0.7"
                        d="M39.5 20C39.5 30.7696 30.7696 39.5 20 39.5C9.23045 39.5 0.5 30.7696 0.5 20C0.5 9.23045 9.23045 0.5 20 0.5C30.7696 0.5 39.5 9.23045 39.5 20Z"
                        stroke="none"
...
<script setup lang="js" name="Footer"></script>
