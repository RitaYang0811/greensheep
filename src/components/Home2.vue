  ...
  <div class="container py-16">
    ...
    <div class="row gy-5">
      <div class="col-lg-3 col-6">
        <router-link to="/products?category=項鍊%20PENDANT">
      ...
      <div class="col-lg-3 col-6">
        <router-link to="/products?category=戒指%20RING">
          <div class="card text-white border-0 bg-primary bg-gradient h-border" data-aos="fade-up"
      ...
      <div class="col-lg-3 col-6">
        <router-link to="/products?category=耳環%20EARRINGS">
          <div class="card text-white border-0 bg-primary bg-gradient h-border" data-aos="fade-up"
      ...
      <div class="col-lg-3 col-6">
        <router-link to="/products?category=手鍊%20BRACELET">
          <div class="card text-white border-0 bg-primary bg-gradient h-border" data-aos="fade-up"
  ...
  <div class="container py-16">
    ...
    <div class="craft-content d-flex justify-content-lg-between position-relative flex-lg-nowrap flex-wrap">
      ...
      <div
        ...
        <div class="card-body">
          ...
          <router-link to="/products"
            class="card-link border-bottom py-2 px-3 display-8 text-white custom-btn custom-btn-white shop-now">SHOP
            NOW</router-link>
        </div>
      </div>
      <!-- 平板版定位 -->
      <div
        ...
        <div class="card-body">
          <h5 class="card-title display-6 text-white">Radiate Confidence, Blossom in Brilliance</h5>
          <p class="card-text py-4 fs-8 text-white" style="line-height: 200%">
            每一件珠寶都是一個故事的開端，他們不僅是獨特設計的結晶，更是佩戴者心靈的寄託。以傳統經典風格為基礎，注入優雅的細節和精湛工藝，綻放永恆時尚展現你的自信光芒。
          </p>
          <router-link to="/products"
    ...
    <div class="row">
      <div class="col-lg-3 col-12 d-flex flex-column justify-content-center">
        ...
        <div class="position-relative me-auto d-lg-block d-none">
          <router-link to="/products" class="fs-8 py-2 px-3 text-start custom-btn custom-btn-secondary">Discover
            More</router-link>
        </div>
      </div>
      <div class="col-lg-3">
        <router-link to="/products"> 
          <div class="card text-white border-0 bg-primary bg-gradient h-border position-relative" data-aos="fade-up"
            data-aos-duration="1200" data-aos-delay="200">
        ...
        <router-link to="/products">
          <div class="card text-white border-0 bg-primary bg-gradient h-border" data-aos="fade-up"
            ...
            <div class="card-img-overlay d-flex flex-column justify-content-end p-5 align-items-lg-start">
              ...
              <div>
                <span class="color-choose color-gold me-1"></span><span class="color-choose color-silver"></span>
              </div>
