<template>
    <div class="container py-16">
        <h2 class="fs-6 text-cente fw-bold mb-1 text-primary">產品類別</h2>
        <h3 class="fs-2 mb-6 text-center text-primary">OUR COLLECTIONS</h3>
        <div class="row gy-5">
            <div class="col-lg-3 col-6">
                <a href="2-1.productPage.html">
                    <div class="card text-white border-0 bg-primary bg-gradient h-border" data-aos="fade-up"
                        data-aos-duration="1200" data-aos-delay="200">
                        <!-- 原照片class="show",要更換照片class="change" -->
                        <img src="../assets/images/img-item-1.png" class="card-img img-fluid opacity-75" alt="" />
            ...
            <div class="col-lg-3 col-6">
                <a href="2-1.productPage.html">
                    <div class="card text-white border-0 bg-primary bg-gradient h-border" data-aos="fade-up"
                        ...
                        <img src="../assets/images/img-item-2.png" class="card-img img-fluid opacity-75" alt="..." />
                        <div class="card-img-overlay d-flex flex-column-reverse align-items-start">
            ...
            <div class="col-lg-3 col-6">
                <a href="2-1.productPage.html">
                    <div class="card text-white border-0 bg-primary bg-gradient h-border" data-aos="fade-up"
                        ...
                        <img src="../assets/images/img-item-3.png" class="card-img img-fluid opacity-75" alt="..." />
                        <div class="card-img-overlay d-flex flex-column-reverse align-items-start">
            ...
            <div class="col-lg-3 col-6">
                <a href="2-1.productPage.html">
                    <div class="card text-white border-0 bg-primary bg-gradient h-border" data-aos="fade-up"
                        ...
                        <img src="../assets/images/img-item-4.png" class="card-img img-fluid opacity-75" alt="..." />
                        <div class="card-img-overlay d-flex flex-column-reverse align-items-start">
    ...
    <div class="container py-16">
        ...
        <div class="craft-content d-flex justify-content-lg-between position-relative flex-lg-nowrap flex-wrap">
            ...
            <div class="position-relative ms-auto mt-lg-0 mt-22">
                ...
                <!-- 桌機版定位 -->
                <p class="text-primary position-absolute display-7 text-vertical top-60 end-2 d-lg-block d-none">
                    @greensheep_jewelry
                </p>
                <!-- 手機版定位 -->
                <p class="text-primary position-absolute display-7 text-vertical top-20 end-15 d-lg-none d-block">
                    @greensheep_jewelry
                </p>
            </div>
            <!-- 桌機版定位 -->
            <div class="card d-lg-block d-none position-absolute py-lg-24 px-lg-12 px-4 py-8 border-radius-80 bg-primary bg-opacity-75 border-1 border-greyF7 backdrop-blur top-15 start-53"
                style="max-width: 536px">
                <div class="card-body">
                    <h5 class="card-title display-6 text-white fw-normal">
                        Radiate Confidence, Blossom in Brilliance
                    </h5>
                    ...
                    <a href="2-1.productPage.html"
                        class="card-link border-bottom py-2 px-3 display-8 text-white custom-btn custom-btn-white">SHOP
                        NOW</a>
                </div>
            </div>
            <!-- 平板版定位 -->
            <div class="card d-sm-block d-none d-lg-none position-absolute px-md-8 py-md-16 px-4 py-8 border-radius-40 bg-primary bg-opacity-75 border-1 border-greyF7 backdrop-blur top-33 start-0"
                style="max-width: 400px">
                <div class="card-body">
                    <h5 class="card-title display-6 text-white">
                        Radiate Confidence, Blossom in Brilliance
                    </h5>
                    <p class="card-text py-4 fs-8 text-white" style="line-height: 200%">
                        每一件珠寶都是一個故事的開端，他們不僅是獨特設計的結晶，更是佩戴者心靈的寄託。以傳統經典風格為基礎，注入優雅的細節和精湛工藝，綻放永恆時尚展現你的自信光芒。
            ...
            <!-- 手機版定位 -->
            <div class="card d-sm-none d-block position-absolute px-4 py-8 border-radius-40 bg-primary bg-opacity-75 border-1 border-greyF7 backdrop-blur top-27 start-0"
    ...
    <div class="container-lg py-16 d-lg-block d-none">
        <div class="row">
            <div class="col-lg-3 col-12 d-flex flex-column justify-content-center">
                <h2 class="fs-6 text-primary fw-bold text-lg-start text-cneter">
                    熱賣商品
                </h2>
                <h3 class="fs-2 mb-12 text-primary text-lg-start text-center">
                    OUR BEST SELLERS
                </h3>
                <div class="position-relative me-auto d-lg-block d-none">
                    <a href="2-1.productPage.html"
                        class="fs-8 py-2 px-3 text-start custom-btn custom-btn-secondary">Discover More</a>
                </div>
            </div>
            <div class="col-lg-3">
                <a href="2-1.productPage.html">
                    <div class="card text-white border-0 bg-primary bg-gradient h-border position-relative"
            ...
            <div class="col-lg-3">
                <a href="2-1.productPage.html">
                    <div class="card text-white border-0 bg-primary bg-gradient h-border" data-aos="fade-up"
                        ...
                        <div class="h-border position-relative" style="width: 100%; padding-top: 135%">
                            <img src="../assets/images/img-prod-2.png"
                                class="card-img-top show position-absolute top-0 start-0 object-fit-cover opacity-75"
                                style="width: 100%; height: 100%" alt="天使之愛十字架｜925純銀" />
            ...
            <div class="col-lg-3">
                <a href="2-1.productPage.html">
                    <div class="card text-white border-0 bg-primary bg-gradient h-border" data-aos="fade-up"
                        ...
                        <div class="h-border position-relative" style="width: 100%; padding-top: 135%">
                            <img src="../assets/images/img-prod-3.png"
                                class="card-img-top show position-absolute top-0 start-0 object-fit-cover opacity-75"
                                style="width: 100%; height: 100%" alt="天使之愛十字架｜925純銀" />
                            <img src="../assets/images/product-4-2.jpg"
                                class="card-img-top change position-absolute top-0 start-0 object-fit-cover"
                                style="width: 100%; height: 100%" alt="天使之愛十字架｜925純銀" />
                        </div>
                        <div class="card-img-overlay d-flex flex-column justify-content-end p-5 align-items-lg-start">
                            ...
                            <div>
                                <span class="color-choose color-gold me-1"></span><span
                                    class="color-choose color-silver"></span>
                            </div>
    ...
    <div class="wrap d-lg-none d-block">
        ...
        <div class="container">
            <div class="my-auto mt-6 mb-20">
                <a href="2-1.productPage.html" class="fs-8 py-2 px-3 text-start custom-btn custom-btn-secondary">Discover
                    More</a>
            </div>
        </div>
    </div>
