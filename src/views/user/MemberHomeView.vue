<template>
  ...
  <VForm @submit="updateUser()" v-slot="{ errors }" action=""
    class="py-8 border border-1 border-primary w-100 text-start" style="border-radius: 30px 0">
    <div class="d-flex w-75 mb-5 mx-auto align-items-center">
      <label for="email" class="text-primary me-3 fs-9 fs-md-6 w-10">信箱：</label>
      <input type="email" class="form-control d-inline-block p-2 flex-grow-1" id="email" value="greensheep@google.com"
        disabled v-model="user.email" />
    </div>
    <div class="d-flex w-75 mb-5 mx-auto align-items-center">
      <label for="birthday" class="text-primary me-3 fs-9 fs-md-6 w-10">生日：</label>
      <input type="text" class="form-control d-inline-block p-2 flex-grow-1" id="birthday" value="2000-01-01" disabled
        v-model="user.birthday" />
    </div>
    <div class="d-flex w-75 mb-5 mx-auto align-items-center">
      <label for="pwd" class="text-primary me-3 fs-9 fs-md-6 w-10">密碼：</label>
      <input type="password" class="form-control d-inline-block p-2 flex-grow-1" id="pwd" value="000000"
        v-model="user.password" disabled />
    </div>
    <div class="d-flex w-75 mb-5 mx-auto align-items-center">
      <label for="nickname" class="text-primary me-3 fs-9 fs-md-6 w-10">暱稱：</label>
      <div class="w-100">
        <v-field id="nickname" name="姓名" type="text" class="form-control d-inline-block p-2 flex-grow-1 border-0"
          :class="{ 'is-invalid': errors['姓名'] }" rules="required" v-model="user.nickName"></v-field>
    ...
    <div class="d-flex w-75 mb-5 mx-auto align-items-center">
      ...
      <div class="w-100">
        <v-field id="address" name="地址" type="text" class="form-control d-inline-block p-2 flex-grow-1  border-0"
          :class="{ 'is-invalid': errors['地址'] }" rules="required" v-model="user.location"></v-field>
    ...
    <div class="d-flex w-75 mb-5 mx-auto align-items-center ">
      ...
      <div class="w-100">
        <v-field id="tel" name="電話" type="tel" class="form-control d-inline-block p-2 flex-grow-1  border-0"
          :class="{ 'is-invalid': errors['電話'] }" rules="required|digits:10" v-model="user.phone"></v-field>
